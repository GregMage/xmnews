					...
					<div class="card h-100 xmnews-border" <{if $itemnews.color != false}>style="border-color : <{$itemnews.color}>;"<{/if}>>
						<div class="card-header" <{if $itemnews.color != false}>style="background-color : <{$itemnews.color}>;"<{/if}>>
							<div class="d-flex justify-content-center text-center">
								<h5 class="mb-0 text-white"><{$itemnews.title}><{if $news_cid == 0}><br /><a href="index.php?news_cid=<{$itemnews.cid}>"><span class="badge badge-pill badge-dark" style="font-weight: lighter;" ><{$itemnews.cat_name}></span><{/if}></a></h5>
							</div>
						</div>
