<div class="xmnews">
	...
	<{if $news_count != 0}>
		...
		<div class="panel panel-default" <{if $itemnews.color != false}>style="border-color : <{$itemnews.color}>;"<{/if}>>
			<div class="panel-body">
				<div class="media">
					<div class="media-left">
						<{if $itemnews.logo != ''}>
						<img class="media-object" src="<{$itemnews.logo}>" alt="<{$itemnews.title}>" style="max-width:150px">
						<{/if}>
					</div>
					<div class="media-body">
						<h2 class="media-heading"><{$itemnews.title}><{if $news_cid == 0}> <span class="badge badge-pill badge-dark"><{$itemnews.cat_name}></span><{/if}></h2>
						...
						<div class="xmnews-index-info"><span class="glyphicon glyphicon-user" title="<{$smarty.const._MA_XMNEWS_NEWS_PUBLISHEDBY}>"></span>
							<{$smarty.const._MA_XMNEWS_NEWS_PUBLISHEDBY}> <{$itemnews.author}>
						</div>
						<{/if}>
						...
						<div class="xmnews-index-info"><span class="glyphicon glyphicon-calendar" title="<{$smarty.const._MA_XMNEWS_NEWS_DATE}>"></span>
							<{$smarty.const._MA_XMNEWS_NEWS_ON}> <{$itemnews.date}>
						</div>
						<{/if}>
						...
						<div class="xmnews-index-info"><span class="glyphicon glyphicon-repeat" title="<{$smarty.const._MA_XMNEWS_NEWS_READING}>"></span>
							<{$smarty.const._MA_XMNEWS_NEWS_READING}> <{$itemnews.counter}>
						</div>
						<{/if}>
						...
						<div class="xmnews-index-info"><span class="glyphicon glyphicon-star-empty" title="<{$smarty.const._MA_XMNEWS_NEWS_RATING}>"></span>
							<{$smarty.const._MA_XMNEWS_NEWS_RATING}>: <{$itemnews.rating}>
						</div>
						<{/if}>
						<{/if}>						
					</div>
				...
				<div class="xmnews-index-button">
					<div class="btn-group" role="group" aria-label="...">
						<a href="article.php?news_id=<{$itemnews.id}>">
