						...
						<div class="d-flex justify-content-between">
							...
							<{if $blocknews.dohits == 1}>
								<div class="row align-items-center text-right">
									<div class="col">
										<span class="badge badge-secondary fa-lg text-primary mx-2"><span class="fa fa-eye fa-lg text-primary" aria-hidden="true"></span><small> <{$blocknews.hits}></small></span>
									</div>	
								</div>	
							<{/if}>
						</div>
