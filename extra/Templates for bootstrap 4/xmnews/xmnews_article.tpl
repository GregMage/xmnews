	...
	<nav aria-label="breadcrumb">
	  <ol class="breadcrumb" <{if $category_color != false}>style="border-color : <{$category_color}>;"<{/if}>>
		...
		<li class="breadcrumb-item">
			<a href="index.php?news_cid=<{$category_id}>"><{$category_name}></a>
		</li>
						...
						<div class="d-flex justify-content-between">
							...
							<{if $dohits == 1}>
								<div class="row align-items-center text-right">
									<div class="col">
										<span class="badge fa-lg text-white ml-2"><span class="fa fa-eye fa-lg" aria-hidden="true"></span><small> <{$counter}></small></span>
									</div>	
								</div>	
							<{/if}>
						</div>
