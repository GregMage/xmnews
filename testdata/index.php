...
use Xmf\Request;
use Xmf\Yaml;
use XoopsModules\Xmnews;
use XoopsModules\Xmnews\Common;
...
$helper = Xmnews\Helper::getInstance();
// Load language files
...
function saveSampleData()
{
    ...
    if (!\file_exists($languageFolder . '/')) {
        XmnewsUtility::createFolder($languageFolder . '/');
    }
    $exportFolder = $languageFolder . '/Exports-' . date('Y-m-d-H-i-s') . '/';
    XmnewsUtility::createFolder($exportFolder);
...
function exportSchema()
{
    ...
    try {
        ...
        //        $migrate = new Xmnews\Migrate($moduleDirName);
