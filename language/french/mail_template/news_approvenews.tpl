...
L'article "{NEWS_TITLE}" en attente de validation a été approuvé sur {X_SITENAME}
...
Vous recevez ce message car vous avez choisi d'être notifié lors la validation de cet article.
