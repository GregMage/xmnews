...
define('_MB_XMNEWS_ABSTRACT_DESC', '("all" : sans limite, "0" : Ne pas afficher le résumé des articles)');
...
define('_MB_XMNEWS_TYPE', 'Type de bloc');
define('_MB_XMNEWS_TYPE_DATE', 'Articles récents');
...
define('_MB_XMNEWS_SIZE', 'Largeur de l\'image en pixel');
