...
// permission
define('_MA_XMNEWS_PERMISSION_VIEW', 'Autorisation de voir');
define('_MA_XMNEWS_PERMISSION_VIEW_DSC', 'Choisissez les groupes qui peuvent voir les news dans ces catégories');
