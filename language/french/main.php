...
define('_MA_XMNEWS_NEWS_ADD', 'Ajout d\'une news');
define('_MA_XMNEWS_NEWS_LIST', 'Liste des news');
define('_MA_XMNEWS_REDIRECT_SAVE', 'Enregistré avec succès');
 
// Admin
define('_MA_XMNEWS_INDEXCONFIG_XMDOC_WARNINGNOTINSTALLED', 'Vous n\'avez pas installé le module xmdoc, ce module est requis si vous souhaitez ajouter des documents aux news');
...
define('_MA_XMNEWS_ERROR_NONEWS', 'Il n\'y a pas de news dans la base de données');
define('_MA_XMNEWS_ERROR_NPUBLISHED', 'Cette news n\'est pas encore publiée');
...
define('_MA_XMNEWS_INDEXCONFIG_XMSOCIAL_WARNINGNOTINSTALLED', 'Vous n\'avez pas installé le module xmsocial, ce module est requis si vous souhaitez évaluer les news');
define('_MA_XMNEWS_INDEXCONFIG_XMSOCIAL_WARNINGNOTACTIVATE', 'Vous devez activer dans les préférences du module xmnews l\'utilisation de xmsocial (si vous souhaitez évaluer les news)');

// Category
define('_MA_XMNEWS_CATEGORY_DESC', 'Description');
define('_MA_XMNEWS_CATEGORY_DOCOMMENT', 'Afficher les commentaires');
define('_MA_XMNEWS_CATEGORY_DODSC', 'Valeur par défaut pour les nouvelles news dans cette catégorie');
...
define('_MA_XMNEWS_CATEGORY_LOGOFILE_DSC', 'Logo par défaut pour les news dans cette catégorie');
...
define('_MA_XMNEWS_CATEGORY_THEREARENEWS', 'Il y a <strong>%s</strong> news dans cette catégorie!');
...
define('_MA_XMNEWS_NEWS_MORE', 'Lire la news complete');
...
define('_MA_XMNEWS_NEWS_SELECTCATEGORY', 'Sélectionnez une catégorie pour filtrer les news');
define('_MA_XMNEWS_NEWS_SUREDEL', 'Êtes-vous sûr de vouloir supprimer cette news? %s');
...
define('_MA_XMNEWS_NEWS_WAITING', 'Il y a <strong>%s</strong> news en attente de validation!');
...
// permission
define('_MA_XMNEWS_PERMISSION_VIEW_ABSTRACT', 'Autorisation de voir le résumé d\'une news');
define('_MA_XMNEWS_PERMISSION_VIEW_ABSTRACT_DSC', 'Choisissez les groupes qui peuvent voir le résumé d\'une news dans ces catégories');
define('_MA_XMNEWS_PERMISSION_VIEW_ABSTRACT_THIS', 'Sélectionner les groupes pouvant voir le résumé dans ces catégories');
define('_MA_XMNEWS_PERMISSION_VIEW_NEWS', 'Autorisation de voir une news complète');
define('_MA_XMNEWS_PERMISSION_VIEW_NEWS_DSC', 'Choisissez les groupes qui peuvent voir une news complète dans ces catégories');
define('_MA_XMNEWS_PERMISSION_VIEW_NEWS_THIS', 'Sélectionner les groupes pouvant voir une news complète dans ces catégories');
define('_MA_XMNEWS_PERMISSION_SUBMIT', 'Autorisation de soumettre');
define('_MA_XMNEWS_PERMISSION_SUBMIT_DSC', 'Sélectionner les groupes pouvant soumettre des news dans ces catégories');
...
define('_MA_XMNEWS_PERMISSION_EDITAPPROVE_DSC', 'Sélectionner les groupes pouvant éditer et aprouver des news dans ces catégories');
...
define('_MA_XMNEWS_PERMISSION_DELETE_DSC', 'Sélectionner les groupes pouvant supprimer des news dans ces catégories');
define('_MA_XMNEWS_PERMISSION_DELETE_THIS', 'Sélectionner les groupes pouvant supprimer dans ces catégories');

// user
define('_MA_XMNEWS_HOME', 'Page d\'accueil des news');
