...
define('_MA_XMNEWS_CATEGORY_LOGO', 'Category logo');
define('_MA_XMNEWS_CATEGORY_LOGOFILE', 'Logo file');
define('_MA_XMNEWS_CATEGORY_LOGOFILE_DSC', 'Also used as the default logo for new news created in this category');
