...
define('_MB_XMNEWS_ABSTRACT_DESC', '("all": no limit, "0": not display the abstracts)');
...
define('_MB_XMNEWS_NEWS', 'Display news');
define('_MB_XMNEWS_FULL', 'See the full news');
define('_MB_XMNEWS_TYPE', 'Block type');
define('_MB_XMNEWS_TYPE_DATE', 'Recent News');
...
define('_MB_XMNEWS_SIZE', 'Image width in pixel');
